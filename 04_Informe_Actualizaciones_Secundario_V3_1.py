...
os.system('wmic qfe get Description,hotfixid,installedon /format:texttablewsys > "c:\python\Listado_de_Parches_Despues.txt"')

archivo4 = open('C:\Python\Listado_de_Parches_Despues.txt', mode="r")
...
archivo = open("C:\Python\Informe parchado.txt", "w")
